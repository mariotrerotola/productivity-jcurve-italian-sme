...
def save_text_results(df, model, gamma1, gamma2, min_point, coef_sud, robustness=None):
    ...
    with open(RESULTS_DIR / 'paper_values.txt', 'w') as f:
        ...
        f.write(f"Coeff. South:        {coef_sud:.3f}\n")
...
def main():
    ...
    # 7. Reporting
    save_text_results(df, jcurve_model, gamma1, gamma2, min_point, coef_sud, robustness)
    ...
    print(f"  Coeff. South:       {coef_sud:.4f}")
